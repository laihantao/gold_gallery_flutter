...
class _DetailsPageState extends State<DetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (jewellery == null) {
      return Scaffold(
        ...
        body: Center(
          child: Text(l10n.jewelleryNotFound,
        ...
        slivers: [
          SliverAppBar(
            ...
            leading: _frostedCircleButton(
                Icons.chevron_left_rounded, () => context.pop()),
            ...
            actions: [
              _frostedCircleButton(Icons.ios_share_rounded,
                  () => _showShareDialog(context, appTheme, states)),
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  _buildChipsRow(appTheme, j),
                  const SizedBox(height: 24),
                  _buildSectionLabel(appTheme, 'Purchase'),
                  _buildPurchaseCard(appTheme, l10n, j, sym),
                  if (j.remarks?.isNotEmpty == true) ...[
                    const SizedBox(height: 10),
                    _buildNotesCard(appTheme, j),
                  ],
                  const SizedBox(height: 24),
                  _buildSectionLabel(appTheme, 'Market Value'),
                  _buildMarketValueHero(appTheme, j, sym, effectivePrice,
                      vendorName, isBrandSupported, hasWeight),
                  if (!isBrandSupported && _manualPrice == null) ...[
                    ...
                    Container(
                      ...
                      child: _buildManualPriceInput(appTheme, j, sym),
                    ),
                  ],
                  if (effectivePrice != null && hasWeight) ...[
                    const SizedBox(height: 12),
                    _buildMarketBreakdownCard(appTheme, j, sym, effectivePrice),
                  ],
                  const SizedBox(height: 24),
  ...
  Widget _buildChipsRow(AppTheme appTheme, Jewellery j) {
    ...
    return Wrap(
      ...
      children: [
        ...
        chip(Icons.water_drop_outlined, '${j.goldPurity} Gold'),
        if (j.weight != null)
          chip(Icons.shopping_bag_outlined, '${j.weight}g'),
      ],
    );
  }
  ...
  Widget _buildPurchaseCard(
      AppTheme appTheme, AppLocalizations l10n, Jewellery j, String sym) {
    Widget row(String label, String value,
        {bool isHighlight = false, bool isFirst = false}) {
      return Container(
        ...
        child: Row(
          children: [
            Expanded(
              flex: 4,
              child:
                  Text(label, style: TextStyle(color: appTheme.inkLight, fontSize: 12)),
            ),
            Expanded(
              flex: 5,
              child: Text(
    ...
    final moreFields = <({String label, String value})>[
      ...
      (label: l10n.rowPurity, value: '${j.goldPurity} Gold'),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (j.laborFees != null)
            row(l10n.rowLaborFees,
                '$sym ${j.laborFees!.toStringAsFixed(2)}'),
          row(
            l10n.rowTotalPrice,
            j.totalPrice != null
          ...
          if (_showMoreDetails)
            ...moreFields.map((f) => row(f.label, f.value)),
          if (_showMoreDetails)
  ...
  Widget _buildNotesCard(AppTheme appTheme, Jewellery j) {
    return Container(
            ...
            child: Column(
              ...
              children: [
                          ...
                          children: [
                            ...
                            if (!isBrandSupported && _manualPrice != null) ...[
                              ...
                              Icon(Icons.edit_outlined,
                                  size: 9, color: appTheme.primaryLight),
                            ],
                          ],
                        ),
                      ),
                ...
                if (!hasWeight) ...[
                  ...
                  Text(
                    isBrandSupported
                        ? 'Fetch prices on the Home tab'
                        : '${j.brand} has no live feed',
                    style: TextStyle(
                        color: Colors.white.withValues(alpha: 0.45),
                        fontSize: 13),
                  ),
  ...
  Widget _buildMarketBreakdownCard(
      AppTheme appTheme, Jewellery j, String sym, double currentPrice) {
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(22),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildPriceTable(appTheme, j, sym, currentPrice),
          Divider(height: 1, color: appTheme.border.withValues(alpha: 0.4)),
          _buildBuybackEstimator(appTheme, j, sym, currentPrice),
        ],
      ),
    );
  }
  ...
  Widget _buildManualPriceInput(
      AppTheme appTheme, Jewellery j, String sym) {
    return Padding(
        ...
        children: [
          Row(
            children: [
              ...
              const SizedBox(width: 6),
              Expanded(
                child: Text('${j.brand} has no live price feed.',
                    style:
                        TextStyle(color: appTheme.inkLight, fontSize: 12)),
              ),
            ],
          ),
          const SizedBox(height: 10),
          Text(
            "Enter today's ${j.goldPurity} gold price ($sym/g):",
            style: TextStyle(
            ...
            children: [
              Expanded(
                child: TextField(
                  ...
                  style:
                      TextStyle(color: appTheme.inkDark, fontSize: 14),
          ...
          const SizedBox(height: 6),
          Text(
            'This price is for estimation only and is not saved.',
            style: TextStyle(
                color: appTheme.inkLight,
                fontSize: 10,
  ...
  Widget _buildPriceTable(AppTheme appTheme, Jewellery j, String sym,
      double currentPrice) {
    ...
    final pgGainLoss =
        purchasedPg != null ? currentPg - purchasedPg : null;
    final totalGainLoss =
        purchasedTotal != null ? currentTotal - purchasedTotal : null;
    final totalGainLossPct = (totalGainLoss != null &&
            purchasedTotal != null &&
            purchasedTotal > 0)
    ...
    String fmt(double? v) =>
        v != null ? '$sym ${v.toStringAsFixed(2)}' : '—';
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        flex: 4,
                        child: Text(fmtGain(totalGainLoss),
                            style: TextStyle(
                                color: gainColor,
                                fontSize: 12,
                                fontWeight: FontWeight.w700),
  ...
  Widget _buildBuybackEstimator(AppTheme appTheme, Jewellery j, String sym,
      double currentPrice) {
    final weight = j.weight!;
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              Text('Est. Buyback',
                  style: TextStyle(
                      ...
                      fontSize: 12,
                      fontWeight: FontWeight.w600)),
              Text('$sym ${buybackVal.toStringAsFixed(2)}',
                  style: TextStyle(
                      color: appTheme.primaryDark,
                      fontSize: 16,
                      fontWeight: FontWeight.w800,
          ...
          RichText(
            text: TextSpan(
              ...
              children: [
                ...
                TextSpan(
                    text:
                        '${(_buybackPct * 100).toStringAsFixed(0)}%'),
              ],
            ),
          ),
          const SizedBox(height: 8),
          ...
          Text(
            'Excl. labor fees · Drag to adjust deduction rate',
            style: TextStyle(
                color: appTheme.inkLight,
                fontSize: 10,
                fontStyle: FontStyle.italic),
        ...
        children: [
          ...
          if (memberOf.isEmpty)
            Padding(
              ...
              child: Text('Not in any collection yet.',
                  style: TextStyle(
                      color: appTheme.inkLight,
                      fontSize: 12,
                      fontStyle: FontStyle.italic)),
        ...
        actions: [
          TextButton(
            ...
            child: Text(l10n.cancelButton,
                style:
                    TextStyle(color: appTheme.accentSecondary)),
          ),
          TextButton(
            onPressed: () {
  ...
  Widget build(BuildContext context) {
    final Color effectiveLabelColor = isHeader
        ...
        : dimmed
            ? appTheme.inkLight
            : appTheme.textBody;
    final Color effectiveValColor =
        isHeader ? appTheme.inkLight : appTheme.inkDark;
